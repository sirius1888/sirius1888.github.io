...
- **Muse Group** — общий рекламный модуль для продуктов компании, включая Ultimate Guitar и MuseScore: сменные SDK и адаптеры, аналитика, эксперименты и рекламные форматы.
- **Предыдущий опыт** — O!, Inobi, TimelySoft и CS-Soft.

Для демонстраций в телефонах воссоздал отдельные сценарии с тестовыми данными. Первый экран представляет меня как React Native разработчика и Team Lead: основное действие — написать мне, рядом — скачать резюме. Полный стек расположен после кейсов Vinteo и Muse. В Muse сначала показаны задачи и польза для команды, затем пример в приложении; техническая схема раскрывается отдельно. Язык и тему можно переключать.
